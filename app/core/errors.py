...
PDFT-1600 through PDFT-1699: delegated Google Drive operations
"""
...
class ErrorCode(StrEnum):
    ...
    INVALID_DRIVE_REQUEST = "PDFT-1005"
    OUTPUT_FILE_EXISTS = "PDFT-1006"
    ...
    DRIVE_FILE_TOO_LARGE = "PDFT-1305"
    ...
    DRIVE_AUTHENTICATION_ERROR = "PDFT-1600"
    DRIVE_PERMISSION_ERROR = "PDFT-1601"
    DRIVE_FILE_NOT_FOUND = "PDFT-1602"
    DRIVE_INVALID_FILE_TYPE = "PDFT-1603"
    DRIVE_INVALID_FOLDER = "PDFT-1604"
    DRIVE_DOWNLOAD_ERROR = "PDFT-1605"
    DRIVE_UPLOAD_ERROR = "PDFT-1606"
    DRIVE_API_ERROR = "PDFT-1607"
